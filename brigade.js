...
events.on("push", function(e, project) {
  ...
  node.image = "410602862282.dkr.ecr.us-east-2.amazonaws.com/demo-jenkins-pipeline:2.0"
...
//    `kubectl get pods`
     `cd /opt/charts && helm install --namespace jenkins --name   my-jenkins-release -f stable/jenkins/values.yaml  --set serviceType=LoadBalancer --set ImageTag=2.84 stable/jenkins`
